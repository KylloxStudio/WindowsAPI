...
void PongGameScene::Init()
{
	...
	_player1Wall = { Vector2(0, 0), 10, 10000 };
	_player2Wall = { Vector2(1080, 0), 10, 10000 };
	_ball = { Vector2(125, 250), 20, 20 };
	_topWall = { Vector2(0, 0), 10000, 10 };
	_bottomWall = { Vector2(0, 600), 10000, 10 };
	_ballSpeed = 350.0f;
	_player1Score = 0;
	_player2Score = 0;
}

void PongGameScene::Update()
{
	base::Update();
...
void PongGameScene::Render(HDC hdc)
{
	base::Render(hdc);
